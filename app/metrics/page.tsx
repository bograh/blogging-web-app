    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-7xl px-4 py-12">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">API Metrics Dashboard</h1>
            <p className="mt-2 text-muted-foreground">Monitor API performance and usage statistics</p>
          </div>
...
export default function MetricsPageWrapper() {
  return (
    <AuthProvider>
      <MetricsPage />
    </AuthProvider>
